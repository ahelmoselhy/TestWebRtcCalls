...
public class LauncherActivity extends AppCompatActivity {
    ...
    public void startAudioCall(View view) {
        startActivity(new Intent(this, CompleteActivity.class).putExtra("isVideoCall",false));
    }
    public void startVideoCall(View view) {
        startActivity(new Intent(this, CompleteActivity.class).putExtra("isVideoCall",true));
    }
}

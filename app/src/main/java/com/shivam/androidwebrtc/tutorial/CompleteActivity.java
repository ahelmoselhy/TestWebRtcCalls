...
public class CompleteActivity extends AppCompatActivity {
    ...
    private void connectToSignallingServer() {
        try {
            ...
            // $ hostname -I
            String URL = "https://roaa-calls.up-clicks.com/";
...
//MirtDPM4
    ...
    private void initializeSurfaceViews() {
        ...
        binding.soundToggle.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        toggleSpeakerHeadset.setImageResource(R.drawable.speaker);
    ...
    private void startStreamingVideo() {
        ...
        mediaStream.videoTracks.get(0).setEnabled(getIntent().getBooleanExtra("isVideoCall",false));
        peerConnection.addStream(mediaStream);

        binding.videoBtn.setOnClickListener(view -> {
            mediaStream.videoTracks.get(0).setEnabled(!mediaStream.videoTracks.get(0).enabled());
        });
    }
    ...
    @Nullable
    private VideoCapturer createCameraCapturer(@NonNull CameraEnumerator enumerator) {
